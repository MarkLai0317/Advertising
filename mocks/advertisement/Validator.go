...
func (_m *Validator) ValidateCountrySlice(slice []advertisement.CountryCode) error {
	ret := _m.Called(slice)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func([]advertisement.CountryCode) error); ok {
		r0 = rf(slice)
	} else {
		r0 = ret.Error(0)
	}
...
//   - slice []advertisement.CountryCode
...
func (_c *Validator_ValidateCountrySlice_Call) Run(run func(slice []advertisement.CountryCode)) *Validator_ValidateCountrySlice_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].([]advertisement.CountryCode))
	})
	return _c
}
...
func (_c *Validator_ValidateCountrySlice_Call) RunAndReturn(run func([]advertisement.CountryCode) error) *Validator_ValidateCountrySlice_Call {
	_c.Call.Return(run)
	return _c
}

// ValidateGenderSlice provides a mock function with given fields: slice
func (_m *Validator) ValidateGenderSlice(slice []advertisement.GenderType) error {
	ret := _m.Called(slice)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func([]advertisement.GenderType) error); ok {
		r0 = rf(slice)
	} else {
		r0 = ret.Error(0)
	}
...
//   - slice []advertisement.GenderType
...
func (_c *Validator_ValidateGenderSlice_Call) Run(run func(slice []advertisement.GenderType)) *Validator_ValidateGenderSlice_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].([]advertisement.GenderType))
	})
	return _c
}
...
func (_c *Validator_ValidateGenderSlice_Call) RunAndReturn(run func([]advertisement.GenderType) error) *Validator_ValidateGenderSlice_Call {
	_c.Call.Return(run)
	return _c
}

// ValidatePlatformSlice provides a mock function with given fields: slice
func (_m *Validator) ValidatePlatformSlice(slice []advertisement.PlatformType) error {
	ret := _m.Called(slice)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func([]advertisement.PlatformType) error); ok {
		r0 = rf(slice)
	} else {
		r0 = ret.Error(0)
	}
...
//   - slice []advertisement.PlatformType
...
func (_c *Validator_ValidatePlatformSlice_Call) Run(run func(slice []advertisement.PlatformType)) *Validator_ValidatePlatformSlice_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].([]advertisement.PlatformType))
	})
	return _c
}
...
func (_c *Validator_ValidatePlatformSlice_Call) RunAndReturn(run func([]advertisement.PlatformType) error) *Validator_ValidatePlatformSlice_Call {
	_c.Call.Return(run)
	return _c
}
